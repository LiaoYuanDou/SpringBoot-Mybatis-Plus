...
public enum ResultCode implements Serializable {
     ...
     * 必输参数未输
     */
    //ENGLISH_NOPARAMS(-2, "Required parameters are not lost"),
    /**
     * 登录失效，请重新登录
     */
     ...
     * 登录失效，请重新登录
     */
    //ENGLISH_RELOGIN(-1, "Login invalid, please login again"),
    /**
     * 操作成功
     */
    SUCCESS(0, "操作成功"),
     ...
     * 操作成功
     */
    //ENGLISH_SUCCESS(0, "Operation is successful"),
    /**
     * 操作失败
     */
    //ENGLISH_FAILY(1, "operation failure"),
