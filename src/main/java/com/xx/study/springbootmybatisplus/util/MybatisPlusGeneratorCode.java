package com.xx.study.springbootmybatisplus.util;
...
public class MybatisPlusGeneratorCode {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/mybatis-plus?useUnicode=true&characterEncoding=utf-8&serverTimezone=UTC");
        ...
        pc.setParent("com.xx.study.springbootmybatisplus");
        pc.setEntity("pojo");
