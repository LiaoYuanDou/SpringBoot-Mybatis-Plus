...
public class ResultUtil {
    ...
    /*public static Result setResult(int code, Page<?> dataList) {
        ...
        Data data = new Data();
        data.setDataList(dataList);
        data.setTotalCount(dataList.getTotal());
        data.setCurrentPage(dataList.getPageNum());
        data.setPageSize(dataList.getPageSize());
        result.setResultData(data);
